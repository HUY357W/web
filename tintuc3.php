              ...
              <div class="row ">
                <div class="blog-item mb_20">
                  <div class="post-format col-xs-4">
                    <div class="thumb post-img"><a href="#"> <img src="upload/a1.jpg"  alt="OYEENok"></a></div>
                  </div>
                  <div class="post-info col-xs-8 ">
                    <h5> <a href="">Nhẫn Pha Lê</a> </h5>
                    <div class="date pull-left"> <i class="fa fa-calendar" aria-hidden="true"></i>23 May 2016 </div>
                  </div>
                </div>
                <div class="blog-item mb_20">
                  <div class="post-format col-xs-4">
                  <div class="thumb post-img"><a href="#"> <img src="upload/a4.jpg"  alt="OYEENok"></a></div>
                  </div>
                  <div class="post-info col-xs-8 ">
                    <h5> <a href="">Nhẫn Hột Xoàn</a> </h5>
                    <div class="date pull-left"> <i class="fa fa-calendar" aria-hidden="true"></i>11 May 2017 </div>
                  </div>
                </div>
                <div class="blog-item mb_20">
                  <div class="post-format col-xs-4">
                  <div class="thumb post-img"><a href="#"> <img src="upload/a5.jpg"  alt="OYEENok"></a></div>
                  </div>
                  <div class="post-info col-xs-8 ">
                    <h5> <a href="">Nhẫn Kim Cương</a> </h5>
