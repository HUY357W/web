  ...
  include "thuvien.php";
    ...
    <div class="container banner mt_20">
      <div class="main-banner owl-carousel">
        <div class="item"><a href="#"><img src="ass/images/4.jpg" alt="Main Banner" class="img-responsive" /></a></div>
        <div class="item"><a href="#"><img src="ass/images/2.jpg" alt="Main Banner" class="img-responsive" /></a></div>
      </div>
    </div>
</div>
<div class="container">
        ...
        <div class="col-sm-12 mtb_10">
          ...
          <div id="product-tab" class="mt_50">
            <div class="heading-part mb_10 ">
              <h2 class="main_title">Trang Sức Đính Đá</h2>
            </div>
            ...
            <div class="cms_banner mt_50">
              <div class="col-sm-12 mt_10">
                <div id="subbanner3" class="sub-hover">
                  <div class="sub-img"> <a href="#"><img src="ass/images/5.jpg" alt="Sub Banner3" class="img-responsive"></a></div>
                </div>
              </div>
            </div>
          </div>
