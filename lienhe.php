            ...
            <div class="col-md-4 col-xs-12 contact">
              <div class="location mb_50">
                ...
                <div class="address">Office address
                  <br> Trường SPKT Vĩnh Long
                  <br> Phường 2 Thành Phố Vĩnh Long</div>
                <div class="call mt_10"><i class="fa fa-phone" aria-hidden="true"></i>037 5545 981</div>
              </div>
              <div class="Career mb_50">
                <h5 class="capitalize mb_20"><strong>Careers</strong></h5>
                <div class="address">Chăm sóc khách hàng</div>
                <div class="email mt_10"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:leduy113ddss@gmail.com" target="_top">mailto:leduy113ddss@gmail.co</a></div>
              </div>
              <div class="Hello mb_50">
                <h5 class="capitalize mb_20"><strong>Say Hello</strong></h5>
                <div class="address">Trường SPKT Vĩnh Long</div>
                <div class="email mt_10"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:leduy113ddss@gmail.com" target="_top">mailto:leduy113ddss@gmail.co</a></div>
              </div>
            </div>
